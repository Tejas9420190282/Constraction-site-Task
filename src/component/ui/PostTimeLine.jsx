...
export const PostTimeLine = ({ data }) => {
  ...
  return (
    <div className="w-full bg-white dark:bg-neutral-900 font-sans md:px-10" ref={containerRef}>
      <h2 className="text-3xl font-bold mb-10 text-black dark:text-white text-center">
        Post Launch Phase (Q1–Q4)
      </h2>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        {data.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className={`flex flex-col md:flex-row items-center justify-between pt-16 md:gap-10 ${
                isEven ? "" : "md:flex-row-reverse"
              }`}
            >
              // Timeline marker + Q Title 
              <div className="sticky top-40 z-40 flex items-center justify-start max-w-xs lg:max-w-sm md:w-full">
                <div className="h-18 w-18 rounded-full bg-white dark:bg-black flex items-center justify-center relative left-3 md:left-0">
                  <div className="h-10 w-10 rounded-full bg-neutral-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 flex items-center justify-center">
                    <p className="text-white font-bold">Q{index + 1}</p>
                  </div>
                </div>
              ...
              <div className="relative pl-10 md:pl-0 w-full">
                ...
                >
                  <div className={`grid md:grid-cols-2 gap-4 items-center ${isEven ? "" : "md:flex-row-reverse"}`}>
                    {isEven ? (
                      <>
                        <img
                          src={item.image}
                            ...
                            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
                                <div className="h-18 absolute left-3 md:left-3 w-18 rounded-full bg-white dark:bg-black flex items-center justify-center">
                                    <div className="h-10 w-10 rounded-full bg-neutral-200 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2">
                                        <p className="text-white font-bold text-center mx-50% my-50%">
                                            Q{index + 1}
                                        </p>
                                    </div>
                                </div>
